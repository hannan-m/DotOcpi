...
Step-by-step guides for common eMSP workflows.
{: .fs-6 .fw-300 }

These guides walk you through the core operations your eMSP will perform:

- **[Registration](/DotOcpi/guides/registration/)** — Connect to a CPO with the OCPI handshake
- **[Receiving Data](/DotOcpi/guides/receiving-data/)** — Handle location, session, CDR, and tariff pushes from CPOs
- **[Pulling Data](/DotOcpi/guides/pulling-data/)** — Pull and sync data from CPOs
