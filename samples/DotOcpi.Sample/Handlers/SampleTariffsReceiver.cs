...
/// </summary>
public sealed partial class SampleTariffsReceiver(InMemoryDataStore store, ILogger<SampleTariffsReceiver> logger)
    : ITariffsReceiver
{
    ...
    public Task<OcpiResult> OnTariffDeleteAsync(OcpiRequestContext context, string tariffId, CancellationToken ct)
    {
    ...
    public Task<OcpiResult<object>> GetTariffAsync(OcpiRequestContext context, string tariffId, CancellationToken ct)
    {
