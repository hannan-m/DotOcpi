...
internal static class ModuleHandlerFactory
{
    ...
    // LocationReferences
    private static readonly IModuleHandler LocRefsV20 = new ModuleHandler<V2_0.LocationReferences>(
        OcpiJsonOptions.V2_0
    );
    private static readonly IModuleHandler LocRefsV211 = new ModuleHandler<V2_1_1.LocationReferences>(
        OcpiJsonOptions.V2_1_1
    );
    private static readonly IModuleHandler LocRefsV22 = new ModuleHandler<V2_2.LocationReferences>(
        OcpiJsonOptions.V2_2
    );
    private static readonly IModuleHandler LocRefsV221 = new ModuleHandler<V2_2_1.LocationReferences>(
        OcpiJsonOptions.V2_2_1
    );
    ...
    private static readonly IModuleHandler CredentialsV211 = new ModuleHandler<V2_1_1.Credentials>(
        OcpiJsonOptions.V2_1_1
    );
    private static readonly IModuleHandler CredentialsV22 = new ModuleHandler<V2_2.Credentials>(OcpiJsonOptions.V2_2);
    private static readonly IModuleHandler CredentialsV221 = new ModuleHandler<V2_2_1.Credentials>(
        OcpiJsonOptions.V2_2_1
    );
    ...
    private static readonly IModuleHandler CmdResultV211 = new ModuleHandler<V2_1_1.CommandResponse>(
        OcpiJsonOptions.V2_1_1
    );
    private static readonly IModuleHandler CmdResultV22 = new ModuleHandler<V2_2.CommandResult>(OcpiJsonOptions.V2_2);
    private static readonly IModuleHandler CmdResultV221 = new ModuleHandler<V2_2_1.CommandResult>(
        OcpiJsonOptions.V2_2_1
    );
    ...
    private static readonly IModuleHandler ChargingProfileResultV22 = new ModuleHandler<V2_2.ChargingProfileResult>(
        OcpiJsonOptions.V2_2
    );
    private static readonly IModuleHandler ChargingProfileResultV221 = new ModuleHandler<V2_2_1.ChargingProfileResult>(
        OcpiJsonOptions.V2_2_1
    );
    ...
    private static readonly IModuleHandler ActiveProfileV22 = new ModuleHandler<V2_2.ActiveChargingProfile>(
        OcpiJsonOptions.V2_2
    );
    private static readonly IModuleHandler ActiveProfileV221 = new ModuleHandler<V2_2_1.ActiveChargingProfile>(
        OcpiJsonOptions.V2_2_1
    );
